	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php foreach ($cartdata as $v) { ?>
				<tr>
					<td class="col1"><a href="<?php echo U('Index/detail', array('id' => $v['goods_id'])) ?>"><img src="/Public/Uploads/<?php echo $v['info']['goods_thumb'] ?>" alt="" /></a>
						<strong><a href="<?php echo U('Index/detail', array('id' => $v['goods_id'])) ?>"><?php echo $v['info']['goods_name'] ?></a></strong></td>
