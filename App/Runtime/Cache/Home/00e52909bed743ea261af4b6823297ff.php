    ...
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                ...
                <?php } else { ?>
                <li>您好，欢迎来到京西！[<a href="<?php echo U('User/login') ?>">登录</a>] [<a href="<?php
 echo U('User/register') ?>">免费注册</a>] </li>
                <?php } ?>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
			...
			<div class="guide_wrap">
				...
				<div class="hot none">
					<ul>
						...
						<li>
							<dl>
								<dt><a href="<?php echo U('detail', array('id' => $v['id'])) ?>"><img src="/Public/Uploads/<?php $v['goods_thumb'] ?>" alt="" /></a></dt>
								<dd><a href="<?php echo U('detail', array('id' => $v['id'])) ?>"><?php $v['goods_name'] ?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php $v['shop_price'] ?></strong></dd>
							</dl>
						</li>
						<?php } ?>
					</ul>
